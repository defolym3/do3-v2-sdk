import { ChainId, Percent, CurrencyAmount, sqrt, Token, Price, TradeType, Fraction, computePriceImpact, sortedInsert, validateAndParseAddress } from '@defolym3/do3-sdk-core';
...
var V2_FACTORY_ADDRESSES = (_V2_FACTORY_ADDRESSES = {}, _V2_FACTORY_ADDRESSES[ChainId.AMOY] = '', _V2_FACTORY_ADDRESSES[ChainId.ARBITRUM] = '', _V2_FACTORY_ADDRESSES[ChainId.ARBITRUM_SEPOLIA] = '', _V2_FACTORY_ADDRESSES[ChainId.AVALANCHE] = '', _V2_FACTORY_ADDRESSES[ChainId.BASE] = '', _V2_FACTORY_ADDRESSES[ChainId.BASE_SEPOLIA] = '', _V2_FACTORY_ADDRESSES[ChainId.BSC] = '', _V2_FACTORY_ADDRESSES[ChainId.BSC_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.FRAX_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.FUJI] = '', _V2_FACTORY_ADDRESSES[ChainId.HEDERA] = '', _V2_FACTORY_ADDRESSES[ChainId.HEDERA_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.HOLESKY] = '', _V2_FACTORY_ADDRESSES[ChainId.KAIA] = '', _V2_FACTORY_ADDRESSES[ChainId.KAIROS] = '', _V2_FACTORY_ADDRESSES[ChainId.METIS_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.MODE] = '', _V2_FACTORY_ADDRESSES[ChainId.MODE_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.OKX] = '', _V2_FACTORY_ADDRESSES[ChainId.OPBNB_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.OPTIMISM] = '', _V2_FACTORY_ADDRESSES[ChainId.SCROLL] = '', _V2_FACTORY_ADDRESSES[ChainId.SCROLL_SEPOLIA] = '', _V2_FACTORY_ADDRESSES[ChainId.SEPOLIA] = '', _V2_FACTORY_ADDRESSES[ChainId.SHAPE] = '', _V2_FACTORY_ADDRESSES[ChainId.SHAPE_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.SONEIUM_TESTNET] = '', _V2_FACTORY_ADDRESSES[ChainId.UNICHAIN_TESTNET] = '', _V2_FACTORY_ADDRESSES);
var INIT_CODE_HASH = '';
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[ChainId.AMOY] = '', _INIT_CODE_HASHES[ChainId.ARBITRUM] = '', _INIT_CODE_HASHES[ChainId.ARBITRUM_SEPOLIA] = '', _INIT_CODE_HASHES[ChainId.AVALANCHE] = '', _INIT_CODE_HASHES[ChainId.BASE] = '', _INIT_CODE_HASHES[ChainId.BASE_SEPOLIA] = '', _INIT_CODE_HASHES[ChainId.BSC] = '', _INIT_CODE_HASHES[ChainId.BSC_TESTNET] = '', _INIT_CODE_HASHES[ChainId.FRAX_TESTNET] = '', _INIT_CODE_HASHES[ChainId.FUJI] = '', _INIT_CODE_HASHES[ChainId.HEDERA] = '', _INIT_CODE_HASHES[ChainId.HEDERA_TESTNET] = '', _INIT_CODE_HASHES[ChainId.HOLESKY] = '', _INIT_CODE_HASHES[ChainId.KAIA] = '', _INIT_CODE_HASHES[ChainId.KAIROS] = '', _INIT_CODE_HASHES[ChainId.METIS_TESTNET] = '', _INIT_CODE_HASHES[ChainId.MODE] = '', _INIT_CODE_HASHES[ChainId.MODE_TESTNET] = '', _INIT_CODE_HASHES[ChainId.OKX] = '', _INIT_CODE_HASHES[ChainId.OPBNB_TESTNET] = '', _INIT_CODE_HASHES[ChainId.OPTIMISM] = '', _INIT_CODE_HASHES[ChainId.SCROLL] = '', _INIT_CODE_HASHES[ChainId.SCROLL_SEPOLIA] = '', _INIT_CODE_HASHES[ChainId.SEPOLIA] = '', _INIT_CODE_HASHES[ChainId.SHAPE] = '', _INIT_CODE_HASHES[ChainId.SHAPE_TESTNET] = '', _INIT_CODE_HASHES[ChainId.SONEIUM_TESTNET] = '', _INIT_CODE_HASHES[ChainId.UNICHAIN_TESTNET] = '', _INIT_CODE_HASHES);
...
var CHAIN_LP_TOKEN_INFO = (_CHAIN_LP_TOKEN_INFO = {}, _CHAIN_LP_TOKEN_INFO[ChainId.SHAPE_TESTNET] = {
  name: "Defolym3 LP's",
  symbol: 'DEFOL-LP'
}, _CHAIN_LP_TOKEN_INFO[ChainId.SONEIUM_TESTNET] = {
  name: "Defolym3 LP's",
  symbol: 'DEFOL-LP'
}, _CHAIN_LP_TOKEN_INFO[ChainId.BASE] = {
  name: "TunaDriver LPs",
  symbol: 'TUNA-LP'
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, lpInfo.symbol, lpInfo.name);
...
export { BASIS_POINTS, CHAIN_LP_TOKEN_INFO, FIVE, INIT_CODE_HASH, INIT_CODE_HASHES, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, ONE, ONE_HUNDRED_PERCENT, Pair, Route, Router, Trade, V2_FACTORY_ADDRESSES, ZERO, ZERO_PERCENT, _1000, _997, computePairAddress, inputOutputComparator, tradeComparator };
//# sourceMappingURL=do3-v2-sdk.esm.js.map
